                                                            ...
                                                            <td className="px-4 py-3 text-center">
                                                                {hist.file_url ? (
                                                                    <div className="flex items-center justify-center gap-1">
                                                                        ...
                                                                        <a
                                                                            href={hist.file_url}
                                                                            download={`Pencairan_${hist.letter_number.replace(/\s*\/\s*/g, '_')}.pdf`}
                                                                            className="inline-flex items-center gap-1 text-xs bg-blue-50 text-blue-600 px-2 py-1 rounded hover:bg-blue-100 border border-blue-100"
                                                                            title="Download PDF"
                                                                        >
                                                                            <Download size={12} />
                                                                        </a>
                                                            ...
                                                            <td className="px-4 py-3 text-right">
                                                                <div className="flex justify-end gap-1">
                                                                    <button
                                                                        ...
                                                                        className="inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-800 px-2 py-1 rounded hover:bg-blue-50 border border-blue-100"
                                                                        title="Restore data ke form untuk dicetak ulang"
                                                                    >
                                                                        <RefreshCcw size={12} /> Cetak Ulang
                                                                    </button>
                                                                    <button
                                                                        onClick={() => handleDeleteHistory(hist.id)}
                                                                        className="inline-flex items-center gap-1 text-xs text-red-400 hover:text-red-600 px-2 py-1 rounded hover:bg-red-50 border border-red-100"
                                                                        title="Hapus Riwayat"
                                                                    >
                                                                        <Trash2 size={12} />
                                                                    </button>
