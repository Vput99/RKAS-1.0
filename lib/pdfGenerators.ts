...
export const generateUpahTukang = (data: any) => {
    ...
    // Subtotal Row
    body.push([
        { content: 'Jumlah Total', colSpan: 36, styles: { halign: 'right', fontStyle: 'bold', fontSize: 9 } },
    ...
    body.push([
        { content: `Terbilang : # ${terbilangStr} #`, colSpan: 38, styles: { halign: 'center', fontStyle: 'italic', cellPadding: 4, fontSize: 11, textColor: [0, 0, 0] } }
    ]);
